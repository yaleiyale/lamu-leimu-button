!(function () {
  ...
  var lamuleimuDiv = '<div class="sidebar_wo" id="leimu"><img src="/image/bottom/leimu1.png" alt="雷姆" onmouseover="this.src=\'/image/bottom/leimu2.png\'" onmouseout="this.src=\'/image/bottom/leimu1.png\'"></div><div class="sidebar_wo" id="lamu"><img src="/image/bottom/lamu1.png" alt="拉姆" onmouseover="this.src=\'/image/bottom/lamu2.png\'" onmouseout="this.src=\'/image/bottom/lamu1.png\'"></div>';
